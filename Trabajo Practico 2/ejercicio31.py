...
# ya que facilita la lectura del código y su mantenimiento, 
# evita errores por la modificación accidental de valores y 
# permite un fácil ajuste de los valores fijos en caso de ser necesario.
