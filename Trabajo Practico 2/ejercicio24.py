...
#el programa debe imprimir "Lo siento, eres demasiado joven para acceder." Si no cumple con el requisito de la estatura, el programa debe imprimir "Lo siento, eres demasiado bajo para acceder"
...
#para determinar el valor de verdad de una proposición compuesta formada por dos 
#proposiciones simples unidas por "and". La tabla de verdad del "and" se construye evaluando 
#todas las posibles combinaciones de valores de verdad de las proposiciones simples, y determinando 
