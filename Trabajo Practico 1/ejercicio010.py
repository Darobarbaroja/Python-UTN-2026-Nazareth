...
Dividir la cantidad invertida por cada persona entre el total de la inversión y multiplicar por 100 para obtener el porcentaje. 
...
total = inversion_persona1 + inversion_persona2 + inversion_persona3
print("La inversion total fue de :", total)

porcentaje_inversion_persona1 = round((inversion_persona1 / total) * 100, 2)
print("El porcentaje del primero fue : ",porcentaje_inversion_persona1)

porcentaje_inversion_persona2 = round((inversion_persona2 / total) * 100, 2)
print("El porcentaje del segundo fue : ",porcentaje_inversion_persona2)

porcentaje_inversion_persona3 = round((inversion_persona3 / total) * 100, 2)
print("El porcentaje del tercero fue : ",porcentaje_inversion_persona3)
